        ...
        <div className='z-10 mt-[50px] mq980:mt-[30px] relative flex flex-col items-center justify-center rounded-xl'>
            <div className="mq980:w-full  w-[1200px] mt-10">
                ...
                <div className='absolute flex flex-col inset-0 flex items-center justify-center'>
                    <h1 className='text-white text-[85px] mq980:text-[50px] font-bold font-spartan'>ESTUDIO VIAN</h1>
                    <h2 className='text-white text-2xl mq980:text-[20px] mq980:w-full mq980:px-5 w-[800px] text-center'>Tu tranquilidad es nuestra misión: gestionamos tu siniestro con empatía, compromiso y excelencia.</h2>
                </div>
            </div>
        </div>
    );
